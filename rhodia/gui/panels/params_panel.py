    ...
    def _section_grid(self) -> CollapsibleSection:
        return self._sec("Grid Removal", [
            self._r("grid_tolerance", FloatRow(
                ...
                tooltip=(
                    "Aggressiveness of Rhodia grid removal. "
