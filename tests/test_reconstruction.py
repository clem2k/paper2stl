...
from paper2stl.config import PipelineConfig
from paper2stl.device import get_device
from paper2stl.reconstruction import ViewSilhouette, reconstruct
from paper2stl.reconstruction.views import VIEW_AXES, OPPOSITE
...
def test_box_from_three_views_is_watertight():
    ...
    from paper2stl.export import occupancy_to_mesh
